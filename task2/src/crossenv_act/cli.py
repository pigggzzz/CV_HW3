...
def build_parser() -> argparse.ArgumentParser:
    ...
    ev = sub.add_parser("eval", help="Zero-shot offline evaluation on splitD.")
    add_common(ev)
    ...
    ev.add_argument("--success-threshold", type=float, default=0.10, help="Offline proxy success threshold on mean normalized action L1 per action chunk.")
